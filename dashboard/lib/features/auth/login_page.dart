                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.favorite_rounded,
                          color: MaatriTokens.primary, size: 44),
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.settings_outlined,
                          color: MaatriTokens.warning, size: 36),
                      const SizedBox(height: MaatriTokens.space16),
                      Text('Firebase web configuration is required',
...
class _ErrorMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Semantics(
        ...
        child: Container(
          ...
          child: Text(message,
              style: MaatriTokens.type(
                  size: MaatriTokens.type14, color: MaatriTokens.critical)),
        ),
      );
}
